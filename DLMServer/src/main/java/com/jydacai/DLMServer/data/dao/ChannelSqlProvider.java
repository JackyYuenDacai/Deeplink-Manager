...
import com.jydacai.DLMServer.data.model.ChannelExample.Criteria;
import com.jydacai.DLMServer.data.model.ChannelExample.Criterion;
...
public class ChannelSqlProvider {
    ...
    public String updateByPrimaryKeySelective(Channel record) {
        SQL sql = new SQL();
        sql.UPDATE("Channel");
